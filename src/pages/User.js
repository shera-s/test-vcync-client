        ...
        <div className="container max-w-lg mx-auto flex-1 flex flex-col items-center justify-center">
          <div className="bg-white px-1 py-8 rounded shadow-md text-black w-full">
            ...
            >
              <button
                type="button"
                className={`w-full py-3 px-4 text-sm font-medium text-gray-500 bg-gray-100 rounded-l-full border border-gray-200 hover:bg-white hover:text-green-700 ${
                  data?.getProfilebyId?.profiletype == "Business" &&
                  "z-10 bg-white text-green-700"
                }`}
              >
                {t("Business")}
              </button>
              <button
                type="button"
                className={`w-full py-3 px-4 text-sm font-medium text-gray-500 bg-gray-100 rounded-r-full border border-gray-200 hover:bg-white hover:text-green-700 ${
                  data?.getProfilebyId?.profiletype == "Personal" &&
                  "z-10 bg-white text-green-700"
                }`}
              >
                {t("Personal")}
            ...
            <p className="mt-4 mb-4 text-red-700 text-center ">
              {t(showError)}
            </p>
            ...
            <div className="grid grid-cols-2 gap-2 ">
              ...
              Object.keys(Profile)?.length === 0 ? (
                <>
                  <button
                    onClick={() =>
                      setShowError("To View Profile Build It first")
                    }
                ...
                <>
                  <button
                    onClick={() =>
                      navigate(`/${data?.getProfilebyId?.user_id}`)
                    }
                    type="submit"
                    className="py-3 px-2  rounded-xl inline-flex items-center  bg-green-700 text-white hover:bg-green-900 focus:outline-none my-1 mt-4"
                  >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              Object.keys(Profile)?.length === 0 ? (
                <>
                  ...
                  <button
                    onClick={() =>
                      setShowError(t("To_Enable_Build_Profile_first"))
                    }
                    className="py-3 px-2  rounded-xl inline-flex items-center  bg-green-700 text-white hover:bg-green-900 focus:outline-none my-1 mt-4"
                  >
              ...
              ) : data.getProfilebyId?.enable &&
                data.getProfilebyId.enable === true ? (
                <>
                  <button
                    onClick={saveQrCode}
                    className="py-3 px-2  rounded-xl inline-flex items-center  bg-green-700 text-white hover:bg-green-900 focus:outline-none my-1 mt-4"
            ...
            <div className="text-center mb-7">
              ...
              Object.keys(Profile)?.length === 0 ? (
                <>
                  <button
                    onClick={() =>
                      setShowError(t("To_Add_To_Wallet_Build_Profile_first"))
                    }
                    type="submit"
